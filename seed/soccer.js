...
const main = async () => {
  const soccerArticles = [
    ...
    // },
    {
      ...
      "content": "Pep Guardiola has said he plans to leave Manchester City when his current contract runs out in 2023. The 50-year-old Spaniard, who joined City in 2016 and has won three Premier League titles, feels he will need a rest after seven years in charge. Harry Kane training with Lucas Moura on Wednesday at Enfield Harry Kane confirms he is staying at Spurs after accepting City deal is dead. Read more, And the former Barcelona head coach revealed his next ambition is to take charge of a national team. Next step will be a national team, if there is a possibility. A national team is the next step, he said at an XP Investimentos event, as reported by ESPN on Wednesday."
    },
    {
      "category": "soccer",
      ...
      "content": "Spanish and French media reported on Tuesday that Real Madrid had made a €160m (£137m) bid for the 22-year-old World Cup winner who scored 42 goals in all competitions for PSG last season and has reportedly said he wants to move to Spain. Leonardo said that PSG, who have just signed the Argentina forward Lionel Messi from Barcelona, did not plan to discuss the Mbappé matter again with Real Madrid and that if Mbappé wanted to leave he would have to do so on PSG’s terms."
    },
    {
      "category": "soccer",
      ...
      "content": "Chelsea manager Thomas Tuchel was pleased with Romelu Lukaku's dominant display against Arsenal in his first game back as a Chelsea player.Lukaku scored 15 minutes into his second debut for the London club as they went on to beat a tame Arsenal side 2-0. It was a very good start. Of course, that's important when your a striker scores straightaway – and scores straightaway an important goal to bring the lead."
    },
    {
      "category": "soccer",
      ...
      "content": "The English Premier League’s decision not to release players for World Cup qualifiers played in the UK’s red-list countries is set to impact multiple national teams battling for a berth in the 2022 FIFA World Cup. The decision is spurred by EPL clubs not wanting to see their star players sit out matches on their return because of quarantine restrictions by the UK government, which did not provide players an exemption from its rules. Players returning from the UK's red-list countries would have to quarantine for a full 10 days in a managed quarantine hotel. That timetable would force players who traveled for their national team matches to miss two Premier League matches, a UEFA club competition matchday and the third round of the League Cup (Carabao Cup). According to its statement, the EPL’s announcement affects 60 players from 19 Premier League clubs who were due to travel to 26 red-list countries. Among the countries on the list are all 10 South American nations involved in CONMEBOL regional World Cup qualifiers, as well as three of the eight nations in the final round of CONCACAF regional qualifying: Panama, Mexico and Costa Rica. The only European countries on the UK’s red list are Georgia and Turkey. Does the EPL decision affect the USA & Canada. The U.S. and Canada men’s national teams are not impacted by the Premier League’s decision given that their scheduled travel for the three World Cup qualifiers to be played in September do not involve red-list countries. The USA plays in El Salvador (Sept. 2), at home against Canada in Nashville (Sept. 5) and in Honduras (Sept. 8), while two of Canada’s matches will be on home soil (Sept. 2 and Sept. 8) in addition to the match against the USA. The Premier League indicated that it was forced to make its decision after FIFA did not extend its temporary release exception for players required to quarantine on their return to their clubs following international duty. FIFA implemented that exception for international matches during the pandemic beginning in August 2020, allowing clubs not to release players to their national teams if they were forced to quarantine upon their return to their clubs based on local government regulations. Clubs have reluctantly but rightly come to the conclusion that it would be entirely unreasonable to release players under these new circumstances, Premier League Chief Executive Richard Masters said in a league statement. Quarantine requirements mean that players’ welfare and fitness will be significantly impacted. We understand the challenges that exist in the international match calendar and remain open to workable solutions. Spain’s La Liga followed the Premier League’s lead and announced that it would support its clubs’ decision not to release players who were called up by their South American nations. La Liga clubs and other members of the European Club Association (ECA) are particularly incensed because on Aug. 6 FIFA extended the South American international window by three days in September and October to allow for the playing of two rounds of World Cup qualifiers that were canceled because of the pandemic."
    },
    {
      "category": "soccer",
      ...
      "content": "The 32 team names will be split up into four different pots and a name will be drawn from each to give shape to the eight Champions League groups. The one major caveat: No club can play a team from its own country in the group stage. Each team will play a total of six group-stage matches with the top two teams in each group advancing to the Champions League Round of 16 in February 2022. The team that finishes in third place in each group is eliminated, but the consolation prize is that it will drop into the UEFA Europa League knockout stage to face one of the Europa League group-stage runners-up."
    },
    {
      "category": "Soccer",
    ...
    // },
    {
      ...
      "content": "The field is set. Eight nations from the CONCACAF region (North America, Central America and the Caribbean) will compete for three automatic berths to the 2022 Qatar World Cup in the final octagonal qualifying round. The eight countries will face off in a round-robin format with each team playing the other seven opponents once at home and once on the road. The 14 total matches for each national team will begin in September 2021 and wrap up in March 2022. The top three finishers will earn automatic berths to Qatar, while the fourth-place team will head to an intercontinental playoff with a final ticket to Qatar on the line.The Qatar World Cup will be played from Nov. 21 to Dec. 18, 2022."
    }
  ]
